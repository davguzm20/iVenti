...
class VentaController {
  ...
  VentaController(this._ventaService);
  ...
  Future<ReciboEntity> registrarPago(int idVenta, double monto, int idUsuario) {
    return _ventaService.registrarPago(idVenta, monto, idUsuario);
  }

  Future<void> registrarPagoCliente(int idCliente, double monto, int idUsuario) {
    return _ventaService.registrarPagoCliente(idCliente, monto, idUsuario);
  }

  Future<List<ReciboEntity>> obtenerRecibosDeVenta(int idVenta) {
    return _ventaService.obtenerRecibosDeVenta(idVenta);
  }
