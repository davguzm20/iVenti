...
void main() {
  ...
  testWidgets('Sales Detail - flujo completo de detalle, pago y anular', (tester) async {
    ...
    await conn.execute(Sql.named(
      ...
      'nombre': 'E2E Sales Detail', 'email': 'e2e_sales_detail@test.com', 'pin': '123456',
    });
    await conn.execute(Sql.named(
    ...
    final idCliente = (await conn.execute(Sql.named(
      ...
      "VALUES ('e2e_credito', 'e2e_sales_detail', 'e2e_00000001', CURRENT_TIMESTAMP) RETURNING id_cliente",
    ))).first[0] as int;
