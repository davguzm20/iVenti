...
void main() {
  ...
  testWidgets('Login - flujo completo con todos los casos negativos', (tester) async {
    await cleanTestData();
    ...
    expect(find.text('PIN incompleto'), findsOneWidget);
    expect(
      find.text('Ingresa tu PIN de 6 dígitos para continuar.'),
      findsOneWidget,
    );
